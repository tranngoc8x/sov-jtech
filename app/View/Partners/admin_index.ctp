                ...
                <table class="table table-bordered table-striped table-hover datatable">
                    <thead class="sorting">
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('name','Tên đối tác'); ?></th>
                            <th width="60"><div style="text-align:center !important"><?php echo $this->Paginator->sort('status',"Trạng thái"); ?></div></th>
