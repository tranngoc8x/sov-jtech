...
<div class="row-fluid">
	...
	<header><h4 class="title">Thêm mới giới thiệu</h4></header>
        <section class="body">
            <div class="body-inner">
				...
				<div class="control-group">
					<label class="control-label"><?php echo __("Mô tả (hiển thị ở trang danh sách)");?></label>
					<div class="controls">
						<?php
