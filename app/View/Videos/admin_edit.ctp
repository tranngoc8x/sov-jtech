...
<div class="row-fluid">
	...
	<header><h4 class="title">Cập nhật thông tin video</h4></header>
        <section class="body">
            <div class="body-inner">
				<div class="control-group">
					<label class="control-label"><?php echo __("Tiêu đề video");?></label>
					<div class="controls">
						<?php
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php
							$d = "";
							if(!empty($this->request->data['Video']['published'])) $d =  date('d/m/Y H:i',strtotime($this->request->data['Video']['published']));
