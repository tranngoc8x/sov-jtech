<div class="row-fluid">
    ...
    <section class="body">
        <div class="body-inner">
            ...
            <?php if(is_file('files/uploads/events/'.@$this->request->data['Event']['image'])){?>
                <div class="control-group">
                    <label class="control-label"></label>
                    <div class="controls">
                        <div style='margin-bottom: 5px'>
                            <?php echo $this->Html->image('/files/uploads/events/'.$this->request->data['Event']['image'],array('width'=>140));?>
                        </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                    $d = "";
                    if(!empty($this->request->data['Event']['start_date'])) $d =  date('d/m/Y H:i',strtotime($this->request->data['Event']['start_date']));
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                    $de = "";
                    if(!empty($this->request->data['Event']['end_date'])) $de =  date('d/m/Y H:i',strtotime($this->request->data['Event']['end_date']));
