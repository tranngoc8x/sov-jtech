...
<div class="ProductListContainer ListItems DefaultModule">
    ...
    <?php if(isset($advance) && $advance != null) echo $this->element('search') ?>
        <ul class="ProductList">
            <?php foreach ($results as $k => $v): ?>
            <li>
                <div id="ProductImage" class="ProductImage ProductImageTooltip">
                    <?php echo $this->Html->link($this->Html->image('../files/uploads/products/'.$v['Product']['imagesmall'],array('alt'=>$v['Product'][__('titlename')],'width'=>123,'height'=>'130')),array('plugin'=>false,'controller'=>'products','action'=>'view',$this->Link->seo($v['Product']['id'],$v['Product'][__('titlename')])),
                            array(
