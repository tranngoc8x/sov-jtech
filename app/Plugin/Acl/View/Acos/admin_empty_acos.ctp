...
<?php
    ...
    if($actions_exist)
    {
        ...
        echo '<p>';
        echo $this->Html->link( '<span class="icone-remove red"></span> ' . __d('acl', 'Clear ACOs'), '/admin/acl/acos/empty_acos/run', array('confirm' => __d('acl', 'Are you sure you want to destroy all existing ACOs ?'), 'escape' => false));
        echo '</p>';
    }
    else
    {
