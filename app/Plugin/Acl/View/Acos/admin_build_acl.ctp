...
else
{
    ...
    if(count($missing_aco_nodes) > 0)
    {
        ...
        echo '<p>';
        echo $this->Html->link('<span class="icone-plus green"></span> ' . __d('acl', 'Build'), '/admin/acl/acos/build_acl/run', array('escape' => false));
        echo '</p>';
    }
    else
    {
        echo '<p style="font-style:italic;">';
        echo '<span class="icone-ok green"></span> ' . __d('acl', 'There is no ACO node to create');
        echo '</p>';
    }
}
